          ...
          <section>
            <div className="container grid grid-cols-12 gap-8 justify-items-center">
              ...
              <div className="flex flex-col justify-center col-span-12 py-8 md:col-span-6">
                <h2 className="text-4xl font-semibold leading-10 lg:w-8/12">White calzones with marinara sauce</h2>
                <p className="text-xs text-[#eb4a36] italic my-2">Breakfast and Brunch</p>
                <p className="my-6 text-sm leading-6 text-gray-600">Supermarket brands of ricotta contain stabilizers, which can
                  give the
                  cheese
                  a gummy
                  texture when baked.
                ...
                <div className="flex justify-center gap-4 my-12 divide-x">
                  <div className="flex-1 text-center">
                    ...
                    <h3 className="mt-2 text-lg font-medium text-gray-700">Prep time</h3>
                  ...
                  <div className="flex-1 text-center">
                    ...
                    <h3 className="mt-2 text-lg font-medium text-gray-700">Cook time</h3>
                  ...
                  <div className="flex-1 text-center">
                    ...
                    <h3 className="mt-2 text-lg font-medium text-gray-700">Servings</h3>
